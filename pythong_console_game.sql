...
INSERT INTO `client` VALUES (1,'test_user_1','pw123','2022-09-29 13:02:38'),(2,'test subject 2','thepie','2022-09-29 19:41:21'),(3,'aa555','ee555','2022-09-30 19:14:33'),(4,'test user 2','iknow','2022-09-30 19:30:35'),(6,'test run 3','iknow2','2022-09-30 19:36:11'),(7,'test run 4','iknow4','2022-09-30 19:37:44'),(8,'test run 5','iknow5','2022-09-30 19:39:37'),(10,'test user 6','44eee','2022-09-30 20:13:40'),(11,'test user 7','ee999','2022-09-30 21:13:20'),(12,'test user 8','oo999','2022-09-30 21:20:34'),(13,'test user 9','ii999','2022-09-30 21:23:29'),(14,'test10','pw1234','2022-10-02 16:37:04'),(15,'test11','pw1234','2022-10-02 16:39:27');
...
INSERT INTO `fighter` VALUES (1,1,1,2,3,4,'saitama',500000,15),(2,1,5,6,7,8,'Rock',200000,4),(3,13,1,2,3,4,'Saitama',50000,0),(4,15,1,2,3,4,'saitama2',50000,0);
...
begin
	select id, name, health_points, points, move_one, move_two, move_three, move_four  from fighter
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `convert_id_move` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `convert_id_move`(move_id_input int unsigned )
begin
	select name, lower_damage_range, upper_damage_range from move 
	where id = move_id_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-10-04 13:55:44
